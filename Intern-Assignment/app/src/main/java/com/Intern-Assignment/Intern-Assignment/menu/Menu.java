package com.spacester.myfriends.menu;
...
import com.spacester.myfriends.user.MyFollowing;
import com.spacester.myfriends.welcome.IntroLast;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       sharedPref = new SharedPref(this);
        ...
        invite.setOnClickListener(v -> {
            String shareBody = "Intern-Assignment - Friends Social Network" + " Download now on play store \nhttps://play.google.com/store/apps/details?id=com.spacester.myfriends";
